...
public static class SeedData
{
    public static void Initialize(AppDbContext context)
    {
        ...
        var abbreviations = new List<Abbreviation>
        {
            ...
            new() { Short = "XML", Full = "Extensible Markup Language", Category = "Data", Level = "Stajyer" },
            ...
            new() { Short = "DNS", Full = "Domain Name System", Category = "Networking", Level = "Stajyer" },
            new() { Short = "FTP", Full = "File Transfer Protocol", Category = "Networking", Level = "Stajyer" },
            ...
            new() { Short = "LAN", Full = "Local Area Network", Category = "Networking", Level = "Stajyer" },
            new() { Short = "WAN", Full = "Wide Area Network", Category = "Networking", Level = "Stajyer" },
            new() { Short = "TCP", Full = "Transmission Control Protocol", Category = "Networking", Level = "Stajyer" },
            new() { Short = "DB", Full = "Database", Category = "Database", Level = "Stajyer" },
            new() { Short = "CDN", Full = "Content Delivery Network", Category = "Web", Level = "Stajyer" },
            new() { Short = "CMS", Full = "Content Management System", Category = "Web", Level = "Stajyer" },
            new() { Short = "DOM", Full = "Document Object Model", Category = "Web", Level = "Stajyer" },
            new() { Short = "OOP", Full = "Object-Oriented Programming", Category = "Development", Level = "Stajyer" },
            new() { Short = "MVC", Full = "Model View Controller", Category = "Architecture", Level = "Stajyer" },
            new() { Short = "CRUD", Full = "Create Read Update Delete", Category = "Database", Level = "Stajyer" },
            new() { Short = "SDK", Full = "Software Development Kit", Category = "Development", Level = "Stajyer" },
            ...
            new() { Short = "SPA", Full = "Single Page Application", Category = "Web", Level = "Stajyer" },
            new() { Short = "npm", Full = "Node Package Manager", Category = "Development", Level = "Stajyer" },
            new() { Short = "git", Full = "Global Information Tracker", Category = "Development", Level = "Stajyer" },
            new() { Short = "CTA", Full = "Call To Action", Category = "Web", Level = "Stajyer" },
            new() { Short = "UML", Full = "Unified Modeling Language", Category = "Development", Level = "Stajyer" },
            new() { Short = "ERD", Full = "Entity Relationship Diagram", Category = "Database", Level = "Stajyer" },
            new() { Short = "VCS", Full = "Version Control System", Category = "Development", Level = "Stajyer" },
            new() { Short = "QA", Full = "Quality Assurance", Category = "Development", Level = "Stajyer" },
            new() { Short = "UAT", Full = "User Acceptance Testing", Category = "Development", Level = "Stajyer" },
            new() { Short = "UTF", Full = "Unicode Transformation Format", Category = "General", Level = "Stajyer" },
            new() { Short = "ASCII", Full = "American Standard Code for Information Interchange", Category = "General", Level = "Stajyer" },
            new() { Short = "FIFO", Full = "First In First Out", Category = "General", Level = "Stajyer" },
            new() { Short = "LIFO", Full = "Last In First Out", Category = "General", Level = "Stajyer" },
            new() { Short = "WYSIWYG", Full = "What You See Is What You Get", Category = "General", Level = "Stajyer" },
            new() { Short = "FAQ", Full = "Frequently Asked Questions", Category = "General", Level = "Stajyer" },
            new() { Short = "MIME", Full = "Multipurpose Internet Mail Extensions", Category = "Networking", Level = "Stajyer" },
            ...
            new() { Short = "PWA", Full = "Progressive Web App", Category = "Web", Level = "Stajyer" },
            ...
            new() { Short = "BIOS", Full = "Basic Input Output System", Category = "Hardware", Level = "Stajyer" },
            new() { Short = "HDMI", Full = "High Definition Multimedia Interface", Category = "Hardware", Level = "Stajyer" },
            new() { Short = "VGA", Full = "Video Graphics Array", Category = "Hardware", Level = "Stajyer" },
            new() { Short = "PSU", Full = "Power Supply Unit", Category = "Hardware", Level = "Stajyer" },
            ...
            new() { Short = "UPS", Full = "Uninterruptible Power Supply", Category = "Hardware", Level = "Stajyer" },
            new() { Short = "NIC", Full = "Network Interface Card", Category = "Hardware", Level = "Junior" },
            new() { Short = "PCIe", Full = "Peripheral Component Interconnect Express", Category = "Hardware", Level = "Junior" },
            ...
            new() { Short = "DVI", Full = "Digital Visual Interface", Category = "Hardware", Level = "Stajyer" },
            new() { Short = "DP", Full = "DisplayPort", Category = "Hardware", Level = "Stajyer" },
            new() { Short = "DIMM", Full = "Dual Inline Memory Module", Category = "Hardware", Level = "Junior" },
            ...
            new() { Short = "TOML", Full = "Tom's Obvious Minimal Language", Category = "Data", Level = "Junior" },
            ...
            new() { Short = "VLAN", Full = "Virtual Local Area Network", Category = "Networking", Level = "Junior" },
            new() { Short = "TCP/IP", Full = "Transmission Control Protocol / Internet Protocol", Category = "Networking", Level = "Junior" },
            new() { Short = "HTTP2", Full = "HyperText Transfer Protocol Version 2", Category = "Networking", Level = "Junior" },
            new() { Short = "WebSocket", Full = "Web Socket Protocol", Category = "Networking", Level = "Junior" },
            ...
            new() { Short = "SLO", Full = "Service Level Objective", Category = "DevOps", Level = "Junior" },
            new() { Short = "SLI", Full = "Service Level Indicator", Category = "DevOps", Level = "Junior" },
            ...
            new() { Short = "Chaos", Full = "Chaos Engineering", Category = "DevOps", Level = "Mid" },
            ...
            new() { Short = "HAL", Full = "Hypertext Application Language", Category = "Web", Level = "Mid" },
            new() { Short = "gzip", Full = "GNU Zip", Category = "General", Level = "Mid" },
            new() { Short = "LZ4", Full = "LZ4 Compression", Category = "General", Level = "Mid" },
            new() { Short = "Protobuf", Full = "Protocol Buffers", Category = "Data", Level = "Mid" },
            new() { Short = "Avro", Full = "Apache Avro", Category = "Data", Level = "Mid" },
            ...
            new() { Short = "ABA", Full = "ABA Problem", Category = "Development", Level = "Senior" },
            new() { Short = "CSP", Full = "Communicating Sequential Processes", Category = "Architecture", Level = "Senior" },
            new() { Short = "Actor", Full = "Actor Model", Category = "Architecture", Level = "Senior" },
            ...
            new() { Short = "Linkerd", Full = "Linkerd Service Mesh", Category = "DevOps", Level = "Senior" },
            ...
            new() { Short = "SPIRE", Full = "SPIFFE Runtime Environment", Category = "Security", Level = "Senior" },
            ...
            new() { Short = "SSA", Full = "Static Single Assignment", Category = "Development", Level = "Senior" },
            new() { Short = "IR", Full = "Intermediate Representation", Category = "Development", Level = "Senior" },
            ...
            new() { Short = "kqueue", Full = "Kernel Queue", Category = "Networking", Level = "Senior" },
            ...
            new() { Short = "TSO", Full = "Total Store Order", Category = "Hardware", Level = "Senior" },
            new() { Short = "RCU", Full = "Read Copy Update", Category = "Development", Level = "Senior" },
            new() { Short = "LMAX", Full = "Low Latency Mechanical Sympathy", Category = "Architecture", Level = "Senior" },
            new() { Short = "Disruptor", Full = "LMAX Disruptor Pattern", Category = "Architecture", Level = "Senior" },
            new() { Short = "Amdahl", Full = "Amdahls Law", Category = "Architecture", Level = "Senior" },
            new() { Short = "Little", Full = "Littles Law", Category = "Architecture", Level = "Senior" },
            new() { Short = "USL", Full = "Universal Scalability Law", Category = "Architecture", Level = "Senior" },
            new() { Short = "SPACE", Full = "Satisfaction Performance Activity Communication Efficiency", Category = "DevOps", Level = "Senior" },
            new() { Short = "ErrorBudget", Full = "Error Budget", Category = "DevOps", Level = "Senior" },
            new() { Short = "Toil", Full = "Toil Reduction", Category = "DevOps", Level = "Senior" },
            new() { Short = "Runbook", Full = "Runbook Automation", Category = "DevOps", Level = "Senior" },
        };
